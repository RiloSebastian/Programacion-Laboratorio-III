...
class InscripcionController
{
    ...
    function inscripciones($emailAlumno=null, $codigoMateria= null)
    {

        if($emailAlumno == null && $codigoMateria == null)
        {
            return $this->inscripcionesDao->listar();
        }
        else if($emailAlumno == null && $codigoMateria != null || $emailAlumno != null && $codigoMateria != null)
        {
            return $this->inscripcionesDao->getByAttribute("codigoMateria",$codigoMateria);
        }
        else if($emailAlumno != null && $codigoMateria == null)
        {
            return $this->inscripcionesDao->getByAttribute("emailAlumno",$emailAlumno);
        }
    }
}
?>